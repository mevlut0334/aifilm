...
<div class="container-fluid">
    <div class="mb-4">
        <div class="d-flex align-items-center">
            ...
            <h1 class="h2 mb-0">Yeni Slider Ekle</h1>
        </div>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control @error('description_tr') is-invalid @enderror" 
                                  ...
                                  name="description_tr" 
                                  rows="4" 
                                  required>{{ old('description_tr') }}</textarea>
                ...
                <div class="mb-4">
                    <label for="image" class="form-label">Slider Görseli <span class="text-danger">*</span></label>
                    <input type="file" 
                           ...
                           required>
                    <small class="form-text text-muted">
                        Maksimum dosya boyutu: 5MB. Desteklenen formatlar: JPEG, PNG, WEBP
                    </small>
                    @error('image')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
