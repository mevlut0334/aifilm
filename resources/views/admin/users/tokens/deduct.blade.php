...
@section('title', __('tokens.Deduct Tokens'))
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.users.tokens.deduct.post', $user->id) }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            @enderror
                            <small class="form-text text-muted">Maximum: {{ $balance }} tokens</small>
                        </div>
