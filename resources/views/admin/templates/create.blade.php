                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.templates.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title_en') is-invalid @enderror"
                                        id="title_en" name="title_en" required value="{{ old('title_en') }}">
                                    @error('title_en')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title_tr') is-invalid @enderror"
                                        id="title_tr" name="title_tr" value="{{ old('title_tr') }}">
                                    @error('title_tr')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('order') is-invalid @enderror"
                                        id="order" name="order" min="0" value="{{ old('order') }}">
                                    @error('order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3">
                                <h5>Videolar</h5>
                                <p class="text-muted small">Her orientation için ayrı video yükleyebilirsiniz. (MP4, MOV,
                                    AVI - Max 50MB)</p>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted">Bunny CDN'e yükleyip URL'i buraya girin. JPG, PNG veya
                                    WebP</small>
                                @error('poster_url')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
