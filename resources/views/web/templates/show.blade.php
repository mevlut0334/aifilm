...
@section('content')
    ...
    @php
        $displayOrientation = $template->hasVideoForOrientation('landscape')
            ? 'landscape'
            : ($template->hasVideoForOrientation('portrait')
                ? 'portrait'
                : 'square');
    @endphp
        ...
        @auth
            <div class="upload-area">
                ...
                @else
                    ...
                    <form method="POST" action="{{ route('generation-requests.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="custom-file-upload">
                            <input type="file" name="input_image" id="file-input" accept="image/*" required
    ...
    <script>
        ...
        async function previewImage(e) {
            ...
            document.getElementById('file-name').textContent = '⏳ Hazırlanıyor...';
            ...
            try {
                ...
                const dataUrl = await imageCompression.getDataUrlFromFile(renamedFile);
        ...
        function confirmSubmit(e) {
            ...
            const message =
                "{{ __('templates.This action will use :cost tokens. Do you want to continue?', ['cost' => ':cost']) }}";
